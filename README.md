...
- Step3: 
  - 3.1 Goto UCSC, the "Custom Tracks" will be listed in the "My Data". To load a new custom track into the currently displayed track set, click the "add custom tracks" button.
